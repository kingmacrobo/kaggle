...
flags.DEFINE_string('train_mask_edge_dir', '', 'the train mask edge directory')
...
def main():
    ...
    datagen = data.DataGenerator(FLAGS.train_list, FLAGS.test_list, FLAGS.train_mask_dir, FLAGS.train_mask_edge_dir)
